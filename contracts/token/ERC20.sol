...
abstract contract ERC20 is Context, IERC20, IERC20Metadata, Pausable, Ownable {
     ...
     */
    function decreaseAllowance(address spender, uint256 requestedDecrease) public whenNotPaused returns (bool) {
        address owner = _msgSender();
